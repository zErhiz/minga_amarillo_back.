...
function sendVery(req,res){
    ...
    const message ={
        ...
        from: process.env.EMAIL_MAILING,
            ...
            <tr>
            <td align="center">
            <img height="auto" src="https://i.postimg.cc/ZRsYdvrF/Logo.png" style="display:block;border:0px;text-decoration:none;border-style:none;color:#ffffff;border-width:0" width="99" class="CToWUd" data-bit="iit">
            </td>
            </tr>
            <tr>
            <td height="32" style="height:32px;min-height:32px;line-height:32px;font-size:1px">
            ...
            <a href='http://localhost:8000/api/auth/verify/${req.body.verify_code}' style="display:inline-block;width:100%;font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold;line-height:19px;color:#ffffff;text-align:center;text-decoration:none;background-color:#FF5722;border-radius:14px;border-top:12px solid #FF5722;border-bottom:12px solid #FF5722;text-transform:uppercase" target="_blank" data-saferedirecturl="http://localhost:3000/verify/4ffbcdd6f1c0a35bd89e">
            &nbsp;&nbsp;CONFIRM EMAIL
            &nbsp;&nbsp;
            </a>
            </td>
            ...
            Minga Project, Cris - Mate - Lucas - Francisco, 
            </p>
            </td>
            </tr>
            </tbody></table>
